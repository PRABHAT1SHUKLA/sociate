...
const Layout = async ({ children }: LayoutProps) => {
  ...
  // variable to count friend request
  ...
  return (
    <div className="w-full flex h-screen">
      ...
      <div className="hidden md:flex h-full w-full max-w-xs grow flex-col gap-y-5 truncate border-r border-gray-200 bg-white px-6">
        ...
        {/* Displaying User Chats and Overview */}
        <nav className="flex flex-1 flex-col">
          <ul role="list" className="flex flex-1 flex-col gap-y-7">
            {/* Displaying Friends chat list */}
            <li>
            ...
            {/* User Profile and signout options */}
